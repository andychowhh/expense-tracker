...
function SubmitButton({ disabled }: { disabled?: boolean }) {
  ...
  return (
    <button
      ...
      className="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm disabled:bg-red-300 disabld: cursor-not-allowed hover:bg-red-500 sm:ml-3 sm:w-auto"
    >
      {pending ? "Adding" : "Add"}
    </button>
  );
